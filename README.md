...
## 방법 1. Git Clone 후 Claude Desktop 연결
...
## 방법 4. Claude Code에서 로컬 MCP로 사용

현재 repo는 Claude Code 플러그인 marketplace 패키지가 아니라 **로컬 stdio MCP 서버**입니다. Claude Code에서 로컬 MCP 서버를 등록할 때도 아래와 같은 `command`, `args`, `env` 구조를 사용하면 됩니다.
